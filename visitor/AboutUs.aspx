<%@ page title="" language="C#" masterpagefile="~/visitor/Main.master" autoeventwireup="true" inherits="Default2, App_Web_0eg3bryl" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="inside">
        ...
        <div class="img-box">
           ...
           Anyone can search colleges easily according to field of education. Search can also provide according to city.
        </div>
        <p class="p0">
            <span class="txt1">'J' for Job</span>
            <br />
           We provide Job searching facility to the users with different searching criteria.Anyone can search his dream job here...</p>
        <br />
        <br />
        <p class="p0">
            <span class="txt1">'E' for Exams</span><br />
           We provide latest exam materials for our users in diffrent subjects... </p>
    </div>
    <br />
    <br />
    <br />
    <h2>If you Think Some improvements in our service, please send your feedback to us....</h2>
</asp:Content>
