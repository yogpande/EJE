<%@ page title="" language="C#" masterpagefile="~/user side/2.master" autoeventwireup="true" inherits="user_side_Default, App_Web_45dgx1po" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div class="inside">
        <h2>
            Articles</h2>
        <ul class="articles">
            <asp:XmlDataSource ID="XmlDataSource1" runat="server" DataFile="http://feeds.surfnetkids.com/SurfingTheNetWithKids"
            ...
            <asp:DataList ID="DataList1" runat="server" DataSourceID="XmlDataSource1" BorderColor="gray"
                ...
                <ItemTemplate>
                    ...
                    <br />
                    <asp:Label ID="Label1" runat="server" Text='<%# XPath("pubDate") %>' ForeColor="blue"
